        ...
        design: {
            ...
            html: `
                <div class="package-body">
                    ...
                    <p class="muted">Терміни виконання: від 2 до 7 тижнів. Оберіть пакет нижче — ціни та склад відрізняються.</p>
                </div>
            `,
            packages: [
                {
            ...
            html: `
                <div class="package-body">
                    ...
                    <div class="package-price-table">
                        <h5>Вартість і терміни</h5>
                        <div class="package-price-row"><span>Роботи</span><strong>від $280/м²</strong></div>
                        <div class="package-price-row"><span>Термін виконання</span><strong>від 3 місяців</strong></div>
                        <div class="package-price-row"><span>Матеріали</span><strong>за окремим кошторисом</strong></div>
                    </div>
                    <p class="muted">Кошторис матеріалів — на ваш вибір: базовий, середній або преміум сегмент.</p>
                </div>
            `
        },
        furniture: {
            ...
            html: `
                <div class="package-body">
                    ...
                    <div class="package-price-table">
                        <h5>Вартість</h5>
                        <div class="package-price-row"><span>Залежить від обсягу замовлення</span><strong>після замірів і ТЗ</strong></div>
                    </div>
                    <p class="muted">Остаточну вартість формуємо після замірів і погодження технічного завдання.</p>
                </div>
            `
        }
    };
